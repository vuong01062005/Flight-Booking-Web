                ...
                <div class="bg-white">
                    <form id="info-form">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label>Tên</label>
                                <input type="text" name="fname" value="<?php echo $u_fetch['firstName'] ?>" required>
                            </div>
                            <div class="col-md-4">
                                <label>Họ</label>
                                <input type="text" name="lname" value="<?php echo $u_fetch['lastName'] ?>" required>
                            </div>
                            <div class="col-md-4">
                                <label>Tên người dùng</label>
                                <input type="text" name="name" value="<?php echo $u_fetch['username'] ?>" required>
                            </div>
                            <div class="col-md-4">
                                <label>Số điện thoại</label>
                                <input type="number" name="phonenum" value="<?php echo $u_fetch['phone'] ?>" required>
                            </div>
                            <div class="col-md-4">
                                <label>Ngày sinh</label>
                                <input type="date" name="dob" value="<?php echo $u_fetch['dob'] ?>" required>
                            </div>
                            <div class="col-md-8">
                                <label>Địa chỉ</label>
